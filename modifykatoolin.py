...
4) View the contents of sources.list file
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali linux repositories | Added by Katoolin\ndeb http://mirrors.ustc.edu.cn/kali kali-rolling main contrib non-free' >> /etc/apt/sources.list")
					elif repo == "2":
